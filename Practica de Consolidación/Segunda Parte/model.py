...
class Particular(Automovil):
    ...
    def __str__(self) -> str:
        return f'Marca: {self.marca}, Modelo: {self.modelo}, {self.numero_ruedas} ruedas, {self.velocidad} Km/h, {self.cilindrada}cc, {self.numero_puestos} puestos'
...
class Carga(Automovil):
    ...
    def __str__(self) -> str:
        return f'Marca: {self.marca}, Modelo: {self.modelo}, {self.numero_ruedas} ruedas, {self.velocidad} Km/h, {self.cilindrada}cc, {self.peso_carga} kg'
...
class Motocicleta(Bicicleta):
    ...
    def __str__(self) -> str:
        return f'Marca: {self.marca}, Modelo: {self.modelo}, {self.numero_ruedas} ruedas, Tipo: {self.tipo}, Radios: {self.numero_radios}, Cuadro: {self.cuadro}, Motor: {self.motor}'
...
print('La lista de vehiculos creados es:')
